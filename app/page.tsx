...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white flex flex-col items-center p-4">
      ...
      {message && (
        <div className="mt-6 bg-green-600 p-4 rounded-lg shadow-lg w-full max-w-md">
      ...
      {error && (
        <div className="mt-6 bg-red-600 p-4 rounded-lg shadow-lg w-full max-w-md">
      ...
      {loadingProjects ? (
        ...
        <p>Nenhum projeto encontrado. Comece gerando um vídeo!</p>
      ) : (
