...
const VideoProject_1 = __importDefault(require("./lib/models/VideoProject"));
...
const worker = new bullmq_1.Worker("videoProcessing", async (job) => {
    // Usando a URI hardcoded para a conexão com o banco de dados
    await (0, mongodb_1.default)(MONGODB_URI);
    ...
    try {
        ...
        try {
            await VideoProject_1.default.updateOne({ _id: projectId }, {
                status: "Completed",
